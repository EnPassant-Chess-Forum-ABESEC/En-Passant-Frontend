    ...
    >
      ...
      <div className="relative z-30 px-6 md:px-12 w-full max-w-5xl mx-auto mt-[-5vh]">
        <div className="flex flex-col items-start gap-6 border-l border-ep-border pl-8 md:pl-12 py-4">
          <span className="font-mono text-xs text-ep-gray tracking-[0.2em] uppercase chess-cell-dark inline-block px-4 py-2 opacity-0 motion-safe:animate-reveal-up motion-safe:[animation-delay:450ms] motion-reduce:opacity-100">
            <span className="cell-text-primary">[OPENING] EnPassant</span>
          </span>
          <h1 className="text-5xl md:text-7xl font-mono text-ep-black mb-4 leading-none tracking-tight drop-shadow-md opacity-0 motion-safe:animate-reveal-up motion-safe:[animation-delay:600ms] motion-reduce:opacity-100">
            HELLO.<br />
            <span className="text-ep-gray">WE&apos;VE BEEN<br />EXPECTING YOU.</span>
          </h1>
          <p className="font-mono text-sm md:text-base text-ep-gray max-w-md leading-relaxed opacity-0 motion-safe:animate-reveal-up motion-safe:[animation-delay:750ms] motion-reduce:opacity-100">
            400+ PLAYERS DEEP. THE OFFICIAL CHESS FORUM OF ABESEC. A RIGOROUS SPACE FOR TOURNAMENTS, PUZZLES, AND COMMUNITY.
          </p>
          
          <div className="mt-8 flex items-center gap-4 relative opacity-0 motion-safe:animate-reveal-up motion-safe:[animation-delay:900ms] motion-reduce:opacity-100">
            <a href="#community" className="inline-flex items-center justify-center px-8 py-4 font-mono text-xs tracking-widest uppercase chess-cell-dark interactive-active group shadow-[4px_4px_0_0_rgba(241,239,232,0.1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px]">
